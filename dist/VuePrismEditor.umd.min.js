  ...
  return (function(t) {
            ...
            while ((c = m.exec(n))) {
              if (
                ...
                l > g &&
                  ...
                  c[a] > 1 && c.index < n[a] && u.apply(h, c.slice(1)),
                  (d = c[0][a]),
                  (g = l),
                  h[a] >= y))
              )
      ...
      (n("8378").inspectSource = function(t) {
        ...
        (t.exports = function(t, e, n, c) {
          ...
          a && (o(n, "name") || i(n, "name", e)),
            t[e] !== n &&
              (a && (o(n, u) || i(n, u, t[e] ? "" + t[e] : s.join(String(e)))),
              t === r
                ? (t[e] = n)
                : c
                ? t[e]
    ...
    "72d6": function(t, e, n) {
      ...
      function u(t, e) {
        ...
        return function(i, o, u) {
          ...
          var c = this.node,
            ...
            s = this._revisit;
          while (c) {
            if (r(n, a) && c[e]) (c = c[e]), (a = !n);
            else if (1 == c.nodeType && !c[e] && r(n, a)) {
              if (((a = n), !s)) continue;
            } else if (c[t]) (c = c[t]), (a = !n);
            else if (((c = c.parentNode), (a = n), !s)) continue;
            if (!c || this.higher(c, this.root)) break;
            if (i(c) && this.selects(c, u) && this.rejects(c, u)) {
              if (--o) continue;
              return u || (this.node = c), (this.closingTag = a), c;
            }
          }
          return null;
        };
      ...
      (t.exports = o),
        ...
        (o.prototype.next = u("nextSibling", "firstChild")),
        (o.prototype.previous = o.prototype.prev = u(
          "previousSibling",
          "lastChild"
        )),
    ...
    "74a0": function(t, e, n) {
      ...
      function i(t) {
        ...
        for (u = i.index; u < n.length; u++) {
          ...
          c !== u && (o += n.substring(c, u)), (c = u + 1), (o += e);
        }
        return c !== u ? o + n.substring(c, u) : o;
      }
      t.exports = i;
    },
    7726: function(t, e) {
    ...
    "954e": function(t, e, n) {
      ...
      Object.defineProperty(u, "all", {
        get: function() {
          return r || (r = i({}, u.default, u.extras));
        }
      }),
        (c.chars = u.default),
        (c.extras = u.extras),
    ...
    ad9a: function(t, e) {
      ...
      t.exports = function(t, e) {
        var n = o(r(t));
        return e && "string" == typeof e && (e = u(e)), e ? i(t, n, e) : n;
      };
    },
    aef6: function(t, e, n) {
      "use strict";
      ...
      t.exports = function(t) {
        return function(e, n, u) {
          var c,
            ...
            f = o(u, s);
          if (t && n != n) {
            while (s > f) if (((c = a[f++]), c != c)) return !0;
          } else
            for (; s > f; f++)
    ...
    fb15: function(t, e, n) {
      ...
      var i = function() {
            ...
            e.lineNumbers
              ? r(
                  ...
                  [
                    ...
                    e._l(e.lineNumbersCount, function(t, n) {
                      return r(
                        "div",
                        {
                          key: n,
                          ...
                          e._v(
                            "\n      " +
                              e._s(
                                0 === n
                                  ? t
                                  : e.lineNumbersCount[n] ===
                                    e.lineNumbersCount[n - 1]
                                  ? "-"
                                  : t
                              ) +
                              "\n    "
        ...
        u = n("0a0d"),
        c = n.n(u),
        a = (n("aef6"), n("6762"), n("2fdb"), n("28a5"), n("74a0")),
        s = n.n(a);
      function f(t, e) {
        return "text" === e && (t = s()(t)), "<code>".concat(t, "</code>");
      }
      var l = function(t, e) {
          if (!e) return f(t, "text");
          e = e.toLowerCase();
          var n = e;
          if (
        ...
        v = n.n(h),
        g = function(t) {
          return v()(t.replace(/<br>/gm, "\n").replace(/<\/?[^>]*>/gm, ""));
        },
        y = g,
        m = (n("6b54"), n("06db"), n("72d6")),
        b = n.n(m);
      function x(t, e) {
        ...
        if (1 == arguments.length) {
          ...
          return (
            ...
            (r.end = o.toString().length),
            o.setStart(i.startContainer, i.startOffset),
            (r.start = r.end - o.toString().length),
            (r.atStart = 0 === o.startOffset),
        ...
        while ((u = f.next())) {
          ...
          var v = p ? s > l : s >= l;
          if (!c && v && ((c = !0), i.setStart(u, l - h), !a)) {
            i.collapse(!0), S(t, i);
            break;
          }
          if (a && s >= d) {
            i.setEnd(u, d - h), S(t, i);
            break;
          }
        }
      }
      ...
      var _ = x,
        ...
        O = {
          ...
          computed: {
            content: function() {
              return l(this.codeData, this.language);
            },
            lineNumbersCount: function() {
              ...
              return (
                t.forEach(function(t) {
                  t.includes("\\") ? n.push(e) : n.push(e++);
                }),
                this.codeData.endsWith("\n") && n.splice(-1, 1),
                n
              );
            }
          },
          updated: function() {
            this.selection && _(this.$refs.pre, this.selection);
          },
          mounted: function() {
            var t = this;
            ...
            var e = function(e) {
                ...
                document.execCommand("insertHTML", !1, s()(r));
                var i = n.end + r.length;
                t.selection = { start: i, end: i };
                var o = t.getPlain();
                t.recordChange(o, t.selection),
                  t.updateContent(o),
                  t.setLineNumbersHeight();
              },
              n = this.$refs.pre;
          ...
          methods: {
            ...
            handleClick: function(t) {
              this.emitEvents && this.$emit("editorClick", t),
                (this.undoTimestamp = 0),
                (this.selection = _(this.$refs.pre));
            },
            getPlain: function() {
              if (this._innerHTML === this.$refs.pre.innerHTML)
                return this._plain;
              var t = y(p(this.$refs.pre.innerHTML));
              return (
              ...
              if (t !== this.undoStack[this.undoStack.length - 1]) {
                ...
                n - this.undoTimestamp < 3e3
                  ...
                  : (this.undoStack.push(r),
                    this.undoStack.length > 50 && this.undoStack.shift()),
            ...
            handleKeyDown: function(t) {
              if (
                ...
                9 !== t.keyCode || this.ignoreTabKey)
              )
                if (8 === t.keyCode) {
                  var e = _(this.$refs.pre),
                    n = e.start,
                    r = e.end;
                  if (n !== r) return;
                  var i = j(this.$refs.pre.innerText, n);
                  if (i <= 0) return;
                  for (var o = 0; o < i; o++)
                    document.execCommand("delete", !1);
                  t.preventDefault();
                } else if (13 === t.keyCode) {
                  var u = _(this.$refs.pre),
                    c = u.start,
                    a = k(this.$refs.pre.innerText, c);
            ...
            handleKeyUp: function(t) {
              if (
                ...
                if (
                  ...
                  var e = this.getPlain();
                  this.recordChange(e, this.selection), this.updateContent(e);
                } else this.undoTimestamp = 0;
            }
          }
        },
        E = O;
      n("b16a");
      function P(t, e, n, r, i, o, u, c) {
        var a,
      ...
      var N = P(E, i, o, !1, null, null, null),
        $ = N.exports;
      e["default"] = $;
    }
  })["default"];
